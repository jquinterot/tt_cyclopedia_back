...
class LoginAttemptTracker:
    ...
    def __init__(self, max_attempts: int = MAX_LOGIN_ATTEMPTS, lockout_minutes: int = LOCKOUT_DURATION_MINUTES):
        self.max_attempts = max_attempts
        self.lockout_minutes = lockout_minutes
        self.attempts: Dict[str, Tuple[int, Optional[datetime]]] = {}
    
    def record_failed_attempt(self, identifier: str) -> Tuple[bool, int, Optional[datetime]]:
        """
    ...
    def get_lockout_remaining_time(self, identifier: str) -> Optional[int]:
        """
...
def record_failed_login(username: str) -> Dict:
    ...
    """
    is_locked, attempts_remaining, lockout_until = login_attempt_tracker.record_failed_attempt(username)
