...
class EnvironmentConfig:
    ...
    def is_docker() -> bool:
        ...
        return (
            ...
            or os.getenv("DOCKER_ENV") == "true"  # Custom Docker env var
            or os.getenv("KUBERNETES_SERVICE_HOST") is not None  # Kubernetes (often in Docker)
        )
