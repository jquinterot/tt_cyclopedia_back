...
from sqlalchemy import Column, String, Integer, DateTime, Float, Text, ForeignKey, UniqueConstraint
import shortuuid
...
class EquipmentReview(Base):
    ...
    if schema_kwargs:
        __table_args__ = (UniqueConstraint('user_id', 'equipment_id', name='_user_equipment_review_uc'), schema_kwargs)
    else:
        __table_args__ = (UniqueConstraint('user_id', 'equipment_id', name='_user_equipment_review_uc'),)
